        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SukSamAcc = table.Column<int>(type: "int", nullable: false),
                    Ppf = table.Column<int>(type: "int", nullable: false),
                    LifeInsurance = table.Column<int>(type: "int", nullable: false),
                    TuitionFee = table.Column<int>(type: "int", nullable: false),
                    FixedDeposit = table.Column<int>(type: "int", nullable: false),
                    PrincipalAmount = table.Column<int>(type: "int", nullable: false),
                    NPS = table.Column<int>(type: "int", nullable: false),
                    HighEduLoan = table.Column<int>(type: "int", nullable: false),
                    HousingLoanInterest = table.Column<int>(type: "int", nullable: false),
                    HouseRent = table.Column<int>(type: "int", nullable: false),
                    TDS = table.Column<int>(type: "int", nullable: false),
                    MediClaim = table.Column<int>(type: "int", nullable: false),
                    FamilyHealth = table.Column<int>(type: "int", nullable: false),
